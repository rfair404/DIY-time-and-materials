...
class DIYTAM_Admin extends DIYTAM_Common {
    ...
    function register_settings() {
        ...
        add_settings_section( $this->get_textdomain() . '_main' ,          __('Adjust the time and materials appearance to your liking by configuring the options below.' , $this->get_textdomain() ), array( $this, 'setting_section_callback') , $this->get_textdomain() );
        add_settings_field( $this->get_textdomain() . '_display_settings', __('Set the color of the text.',                           $this->get_textdomain() ),  array( $this, 'display_fields_callback' ) ,    $this->get_textdomain() ,  $this->get_textdomain() . '_main' );
    ...
    function register_menu() {
        add_options_page( __('DIY Time and Materials', $this->get_textdomain() ), __('DIY Time and Materials', $this->get_textdomain() ), 'manage-options', $this->get_textdomain(), array( $this, 'page_display' ) );
    }
    ...
    function page_display() {
            ?><div class="wrap">
            <h1><?php _e('DIY Time and Materials Options', $this->get_textdomain() ); ?></h1>
            <form method="post" action="options.php" id="<?php echo $this->get_textdomain(); ?>">
            <?php
